...
<style>
    .small-box {
        border-radius: 15px; /* Sesuaikan nilai radius sesuai kebutuhan Anda */
        overflow: hidden; /* Untuk memastikan konten tidak melampaui radius */
        height: 150px;
        box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Optional: menambahkan bayangan untuk efek tiga dimensi */
    }
